...
RSpec.describe User, type: :model do
  describe 'Validations' do
    subject {described_class.new(first_name: 'Anto', last_name: 'Ter-Mesropian', email: 'anto@anto.com', password: '123456', password_confirmation: '123456')}
    ...
    describe 'Email uniqueness' do
      it 'should have unique email address' do
        user = User.new(first_name: 'Anto', last_name:'Ter-Mesropian', email: 'anto@anto.com', password: '123456', password_confirmation: '123456')
        user.save
        subject.valid?
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'should pass with the correct email and password' do
      user = User.new(first_name: 'Anto', last_name:'Ter-Mesropian', email: 'anto@anto.com', password: '123456', password_confirmation: '123456')
      user.save
      result = User.authenticate_with_credentials('anto@anto.com', '123456')
    ...
    it 'should not pass with wrong email and password' do
      user = User.new(first_name: 'Anto', last_name:'Ter-Mesropian', email: 'anto@anto.com', password: '123456', password_confirmation: '123456')
      user.save
      result = User.authenticate_with_credentials('anto@123.com', '123456')
